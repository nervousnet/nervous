...
public class AssetsMbTileSource implements ITileSource {

	private Context context;
	private String name;
	private ITileSource enclosedSource;
	private int minZoom;
	private int maxZoom;
	...
	public AssetsMbTileSource(Context context, String name, int minZoom, int maxZoom) {
		...
		MapTileProviderArray providerArray = new MapTileProviderArray(localSource, null, new MapTileModuleProviderBase[]{moduleProvider});
		
		this.enclosedSource = providerArray.getTileSource();
	}

	@Override
	public Drawable getDrawable(String arg0) throws LowMemoryException {
		return enclosedSource.getDrawable(arg0);
	}
	...
	public String getTileRelativeFilenameString(MapTile arg0) {
		return enclosedSource.getTileRelativeFilenameString(arg0);
	}

	@Override
	public int getTileSizePixels() {
		return enclosedSource.getTileSizePixels();
	}

	@Override
	public String localizedName(ResourceProxy arg0) {
		return enclosedSource.localizedName(arg0);
	}

	@Override
	public String name() {
		return enclosedSource.name();
	}

	@Override
	public int ordinal() {
		return enclosedSource.ordinal();
	}
